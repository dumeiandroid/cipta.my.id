...
const KarirEngine = (() => {
  ...
  // Scoring: jumlah semua nilai jawaban (numerik). Max = 70.
  const MOTIVASI_LEVELS = [
    {
      minSkor: 56,
      title: 'Motivasi Kepemimpinan Sangat Kuat', color: '#27ae60', icon: '🔥',
      description: 'Luar biasa! Anda memiliki motivasi yang sangat kuat untuk menjadi pemimpin. Anda menunjukkan sikap ideal yang diperlukan untuk memimpin dan mengorganisasikan orang lain. Anda memiliki bakat natural sebagai pemimpin yang dapat menginspirasi dan mempengaruhi orang lain.',
      factors: [
    ...
    },
    {
      ...
      description: 'Anda menunjukkan keragu-raguan dalam motivasi kepemimpinan. Di satu sisi Anda tertarik untuk memimpin, namun di sisi lain masih ada keraguan dan ketidakpastian. Anda perlu lebih tegas, mandiri, dan berani mengambil tanggung jawab yang lebih besar.',
      factors: [
      ...
      suggestions: [
        'Identifikasi sumber keragu-raguan Anda - apakah dari kurang percaya diri, pengalaman buruk, atau faktor lain',
        ...
        'Keluar dari comfort zone secara bertahap - ambil tanggung jawab yang sedikit lebih besar dari biasanya',
        'Refleksikan pengalaman kepemimpinan masa lalu - apa yang berhasil dan apa yang perlu diperbaiki',
        'Bangun support system dengan orang-orang yang mendukung perkembangan Anda',
    ...
    },
    {
      ...
      description: 'Saat ini Anda menunjukkan motivasi yang rendah untuk menjadi pemimpin. Anda cenderung lebih nyaman sebagai pelaksana daripada pemimpin. Perlu mengembangkan karakteristik dan mindset kepemimpinan agar tidak hanya puas menjadi pelaksana tugas biasa.',
      factors: [
      ...
      suggestions: [
        'Pahami bahwa tidak semua orang harus menjadi pemimpin - identifikasi apakah ini memang bukan passion Anda atau hanya karena kurang pengalaman',
        'Jika ingin mengembangkan kepemimpinan, mulai dari memimpin diri sendiri - discipline, goal-setting, self-management',
        'Cari tahu role model pemimpin yang Anda kagumi dan pelajari apa yang membuat mereka menarik',
        ...
        'Cari mentor atau coach yang bisa membimbing perjalanan pengembangan kepemimpinan Anda',
        ...
        'Evaluasi apakah Anda lebih cocok sebagai individual contributor expert atau perlu mengembangkan jalur kepemimpinan',
        'Jika memutuskan tidak ingin menjadi pemimpin, itu juga pilihan yang valid - fokus menjadi expert di bidang Anda',
        'Namun tetap kembangkan leadership skills dasar karena berguna dalam berbagai aspek kehidupan'
      ]
    }
  ];

  // ─── DATA TES 24 — Manajemen Waktu ───────────────────────────────────────
  // Scoring: jumlah semua nilai jawaban (numerik). Max = 30.
  const MANWAK_LEVELS = [
    {
      minSkor: 28,
      title: 'Hasil Tidak Valid - Kemungkinan Tidak Jujur', color: '#c0392b', icon: '⚠️',
      description: 'Hasil tes menunjukkan skor yang terlalu sempurna dan tidak realistis. Kemungkinan besar jawaban yang Anda berikan tidak mencerminkan kebiasaan sehari-hari yang sebenarnya. Untuk mendapatkan hasil yang bermakna, cobalah lebih jujur dalam menilai kebiasaan manajemen waktu Anda.',
      warning: 'Manajemen waktu yang sempurna sangat jarang terjadi dalam praktik. Setiap orang pasti memiliki area yang perlu diperbaiki. Kejujuran dalam self-assessment adalah langkah pertama untuk perbaikan yang nyata.',
      aspects: [
    ...
    },
    {
      ...
      description: 'Luar biasa! Anda adalah pengelola waktu yang sangat efektif dan produktif. Anda benar-benar menguasai seni manajemen waktu dan mampu mengoptimalkan setiap menit dalam hari Anda. Kemampuan Anda dalam memprioritaskan, merencanakan, dan melaksanakan tugas patut diacungi jempol.',
      warning: null,
      aspects: [
      ...
      suggestions: [
        ...
        'Dokumentasikan best practices Anda untuk referensi di masa depan',
        'Eksplorasi tools dan teknologi baru untuk meningkatkan produktivitas',
        'Ingat untuk schedule downtime dan self-care dalam agenda Anda'
      ]
    },
    {
      minSkor: 21,
      title: 'Manajemen Waktu Sangat Baik', color: '#27ae60', icon: '✅',
      description: 'Bagus sekali! Anda mampu membuat skala prioritas dengan baik dan bijaksana dalam mengelola waktu. Anda memiliki sistem yang efektif untuk mengorganisir tugas dan tanggung jawab. Dengan sedikit penyempurnaan, Anda bisa mencapai level excellence.',
      warning: null,
      aspects: [
      ...
      suggestions: [
        ...
        'Delegate tugas yang bisa dikerjakan orang lain',
        'Gunakan teknologi untuk automasi tugas rutin',
        'Set boundaries yang jelas untuk melindungi waktu produktif Anda',
        'Praktikkan saying no pada komitmen yang tidak align dengan prioritas',
        'Batch similar tasks untuk meningkatkan efisiensi'
      ]
    },
    {
      minSkor: 11,
      title: 'Manajemen Waktu Cukup Baik - Perlu Peningkatan', color: '#2980b9', icon: '📈',
      description: 'Anda sudah memiliki dasar yang baik dalam manajemen waktu, tetapi masih ada beberapa hal yang perlu diperbaiki. Anda kadang kesulitan dengan prioritas atau terganggu oleh distraksi. Dengan perbaikan yang konsisten, Anda bisa meningkatkan produktivitas secara signifikan.',
      warning: null,
      aspects: [
        { icon: '~', text: 'Prioritas kadang masih blur' },
      ...
      suggestions: [
        ...
        'Kurangi multitasking - fokus pada satu tugas sampai selesai atau mencapai milestone',
        'Buat morning routine yang konsisten untuk memulai hari dengan produktif',
        'Review hari Anda setiap malam - apa yang berhasil dan apa yang perlu diperbaiki',
        'Matikan notifikasi yang tidak penting saat bekerja',
        'Alokasikan buffer time antara meetings atau tugas untuk transisi',
        'Belajar estimasi waktu yang lebih akurat untuk setiap tugas',
        'Cari accountability partner untuk saling support dalam habit building',
        'Mulai dengan satu habit improvement, jangan overwhelm diri dengan perubahan besar sekaligus'
      ]
    },
    {
      minSkor: 0,
      title: 'Perlu Belajar Mengelola Waktu', color: '#e67e22', icon: '⏳',
      description: 'Anda perlu segera mulai memperbaiki cara mengelola waktu. Saat ini waktu Anda banyak terbuang percuma dan produktivitas masih sangat rendah. Namun kabar baiknya, manajemen waktu adalah skill yang bisa dipelajari dan ditingkatkan dengan praktek yang konsisten.',
      warning: null,
      aspects: [
      ...
      suggestions: [
        'Mulai dengan langkah paling dasar: tulis semua tugas Anda dan buat daftar prioritas sederhana',
        ...
        'Eliminasi atau kurangi aktivitas yang menghabiskan waktu tanpa hasil (scrolling media sosial berlebihan, dll)',
        ...
        'Minta bantuan dari orang yang lebih terorganisir untuk tips praktis',
        'Gunakan alarm atau reminder untuk membantu disiplin waktu',
        'Buat lingkungan yang mendukung fokus - kurangi distraksi fisik',
        'Reward diri sendiri ketika berhasil menyelesaikan tugas tepat waktu',
        'Ikuti kursus atau baca buku tentang produktivitas dan time management',
        'Jangan menyerah - perubahan kebiasaan membutuhkan waktu dan konsistensi'
      ]
    }
  ];
  ...
  function score21(rawData) {
    ...
    let totalSkor = 0;
    arr.forEach(v => totalSkor += parseInt(v) || 0);
  ...
  function score22(rawData) {
    const x07 = JSON.parse(rawData.x_07 || '{}');
    // who_22: jawaban per soal, tiap soal punya tag style (demo/oto/lais/pat)
    // Format: string panjang, hitung kemunculan setiap style dari key terpisah
    // Fallback: hitung dari who_22 sebagai array, mapping posisi ke style
    const arr = (x07['who_22'] || '').split(';').filter(v => v !== '');
    // 28 soal, tiap 7 soal = 1 style: demo, oto, lais, pat (4×7=28)
    const styleOrder = ['demo', 'oto', 'lais', 'pat'];
    let combined = GAYA_KEPEMIMPINAN_STYLES.map((s, i) => {
  ...
  async function load(tesId) {
    ...
    if (!token) {
      return Promise.reject({ message: 'Token tidak ditemukan. Silakan kembali dan isi form terlebih dahulu.' });
    }
    ...
    try {
      ...
      return Promise.reject({ message: e.message || 'Terjadi kesalahan koneksi ke server.' });
    }
    ...
    let scored;
    switch (tesId) {
      case '20': scored = score20(rawData); break;
      case '21': scored = score21(rawData); break;
      case '22': scored = score22(rawData); break;
      case '23': scored = score23(rawData); break;
      case '24': scored = score24(rawData); break;
      case '25': scored = score25(rawData); break;
      case '27': scored = score27(rawData); break;
      default: return Promise.reject({ message: `Tes ID "${tesId}" tidak dikenal.` });
    }
  ...
  return {
    load,
    // Data mentah bisa diakses langsung jika dibutuhkan view
    DATA: {
      RIASEC_CATEGORIES,
      RIASEC_SUGGESTIONS,
      KEPEMIMPINAN_LEVELS,
