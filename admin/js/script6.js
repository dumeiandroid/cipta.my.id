...
/**
 * Fungsi asinkron untuk memuat data dari API menggunakan Fetch API dan menampilkannya di tabel.
 */
async function muatData() {
    ...
    try {
        ...
        badanTabel.innerHTML = `<tr><td colspan="${jumlahBidangX + 2}" class="text-center py-4 text-danger">Error memuat data!</td></tr>`;
    }
}
...
async function simpanData() {
    ...
    try {
        ...
        await muatData(); // Pastikan data dimuat ulang setelah operasi selesai
